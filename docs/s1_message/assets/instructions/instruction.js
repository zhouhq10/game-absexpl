var dungeonInstructions = (function (jspsych) {
    'use strict';
     ...
     *
     * plugin for displaying instructions with interactive games, based on jsPsych instructions plugin
     *
     * @author Hanqi Zhou
     * @see {@link https://www.jspsych.org/plugins/jspsych-instructions/ instructions plugin documentation on jspsych.org}
     */
    class DungeonInstructionsPlugin {
        constructor(jsPsych) {
    ...
    DungeonInstructionsPlugin.info = info;
  
    return DungeonInstructionsPlugin;
