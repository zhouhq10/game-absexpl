...
var jsPsychFreeFormText = (function (jspsych) {
  'use strict';
      ...
      parameters: {
          questions: {
              ...
              nested: {
                  ...
                  /** Prefix in front of text box (e.g. $). Only works with single-row text box. **/
                  prefix: {
                      type: jspsych.ParameterType.STRING,
                      pretty_name: "Prefix",
                      default: "",
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              html +=
                  '<div id="jspsych-survey-text-' +
                      question_index +
                      '" class="jspsych-survey-text-question" style="margin: 2em auto;' +
                      ' width: 800px;">';
              html += '<p class="jspsych-survey-text">' + question.prompt + "</p>";
              var autofocus = i == 0 ? "autofocus" : "";
              var req = question.required ? "required" : "";
              if (question.rows == 1) {
                  html += question.prefix +
